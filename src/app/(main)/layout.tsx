...
const NAV_GROUPS: {
  ...
  },
  {
    label: "财务",
    items: [
      { href: "/receivables-payables?view=receivable", label: "客户应收", roles: ["admin", "boss"] },
      { href: "/receivables-payables?view=payable", label: "供应商应付", roles: ["admin", "boss"] },
  ...
  },
  {
    ...
    items: [
      ...
      { href: "/market-data", label: "行情管理", roles: ["admin"] },
