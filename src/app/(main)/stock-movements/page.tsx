        ...
        <table className="min-w-full divide-y divide-gray-200 text-sm">
          <thead className="bg-gray-50 text-left text-xs text-gray-500">
            <tr>
              ...
              <th className="whitespace-nowrap px-4 py-3 font-medium tabular-nums">变动数量</th>
              <th className="whitespace-nowrap px-4 py-3 font-medium tabular-nums">变动前</th>
            ...
            {movements.map((m) => {
              ...
              return (
                <tr key={m.id}>
                  ...
                  <td className={`px-4 py-2.5 tabular-nums font-medium ${Number(m.changeQty) < 0 ? "text-red-600" : "text-green-700"}`}>
